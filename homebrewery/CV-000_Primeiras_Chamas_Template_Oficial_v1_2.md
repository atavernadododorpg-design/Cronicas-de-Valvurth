<!--
CV-000 — PRIMEIRAS CHAMAS
TEMPLATE OFICIAL v1.2 — AJUSTES DE LAYOUT
Homebrewery V3 • A4

Diretriz de acabamento:
- material introdutório gratuito;
- design limpo e elegante;
- fontes seguras para exportação em PDF;
- uso comedido de imagens;
- produtos pagos poderão usar mais ilustrações e ornamentos.

ASSETS:
SELO: https://raw.githubusercontent.com/atavernadododorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/covers/Cronicas%20de%20Valvurth%20Selo.webp
VISTA DA CIDADE: https://raw.githubusercontent.com/atavernadododorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/covers/Criatal%20V%C3%A9lho%20Vista%20da%20Colina.webp
SALMÃO EM PIRACEMA: https://raw.githubusercontent.com/atavernadododorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/locations/Salm%C3%A3o%20em%20Piracema.webp
MARA: https://raw.githubusercontent.com/atavernadodorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/npcs/Mara.webp
MAPA: https://raw.githubusercontent.com/atavernadododorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/maps/Mapa%20Cristal%20V%C3%A9lho.webp
-->
...
/* O Homebrewery controla as colunas nativamente.
   Use \column no conteúdo quando necessário. */

/* ---------- PALETA ---------- */

:root {
  --valvurth-ink: #2b2521;
  --valvurth-wine: #7b2f1d;
  --valvurth-wine-dark: #542116;
  --valvurth-copper: #b98a58;
  --valvurth-cream: #f8f3ea;
  --valvurth-paper: #fffaf1;
  --valvurth-muted: #7d6f64;
}
...
.page h1 {
  ...
  border-bottom: 1.4px solid var(--valvurth-copper);
...
/* Exemplo:
<span class="dropcap">C</span>andelária Velha...
*/
...
.emphasis {
  ...
  border-left: 3px solid var(--valvurth-copper);
  background: rgba(185,138,88,.12);
  color: #4b3328;
...
.box {
  ...
  border: 1px solid rgba(123,47,29,.42);
  border-radius: 1.5mm;

  background: rgba(255,255,255,.48);
  box-shadow: 0 1mm 2mm rgba(60,40,25,.06);
...
.gm-box {
  ...
  border-top: 2px solid var(--valvurth-wine);
  border-bottom: 1px solid rgba(123,47,29,.35);

  background: rgba(123,47,29,.06);

  break-inside: avoid;
}

.gm-box::before {
  content: "PARA O MESTRE";
  display: block;
  margin-bottom: 1.8mm;
...
.quote {
  ...
  border-left: 1.5px solid var(--valvurth-copper);
...
.image-frame {
  ...
  border: 1px solid rgba(123,47,29,.35);
  background: rgba(100,80,65,.08);

  color: var(--valvurth-muted);
  font-size: 9pt;
  font-style: italic;
  text-align: center;
}
...
.brand-seal {
  ...
  object-fit: contain;
  margin-bottom: 4mm;
  filter: drop-shadow(0 1.5mm 2mm rgba(0,0,0,.35));
}
...
.section-image {
  ...
  object-fit: cover;
  border: 1px solid rgba(123,47,29,.28);
}
...
.page td {
  padding: 1.2mm 1.4mm;
  border-bottom: .45px solid rgba(90,70,55,.25);
  vertical-align: top;
}

.page th {
  background: rgba(185,138,88,.22);
  color: var(--valvurth-wine-dark);
...
.page tbody tr:nth-child(even) {
  background: rgba(185,138,88,.055);
}
...
.generator td:first-child,
.generator th:first-child {
  width: 9mm;
  text-align: center;
}
...
.cover-series {
  ...
  border-top: 1px solid rgba(255,232,195,.72);
  border-bottom: 1px solid rgba(255,232,195,.72);
...
.cover-subtitle {
  ...
  border: 1px solid rgba(255,232,195,.58);
...
/* ---------- CORREÇÕES DE COMPATIBILIDADE v1.1 ---------- */

/* Desativa completamente a capitular automática do tema-padrão
   do Homebrewery. Apenas .dropcap manual permanece ativa. */
.page p::first-letter,
...
/* A capitular manual usa apenas fontes seguras. */
.dropcap {
  float: left !important;
  margin: .5mm 1.5mm 0 0 !important;
  color: var(--valvurth-wine) !important;
...
/* Páginas especiais em uma coluna real. */
.page:nth-of-type(1),
.page:nth-of-type(6),
.page:nth-of-type(11),
.page:nth-of-type(16) {
...
/* O mapa deve permanecer integralmente dentro da área útil. */
.page:nth-of-type(6) .map-page {
...
.page:nth-of-type(6) .map {
  display: block !important;
  width: auto !important;
  max-width: 178mm !important;
  height: auto !important;
  max-height: 174mm !important;
  margin: 5mm auto 3mm auto !important;
  object-fit: contain !important;
}

/* Evita que o rodapé seja espelhado nas páginas pares. */
.page::after,
...
/* A capa não recebe rodapé. */
.page:nth-of-type(1)::after {
  content: "" !important;
}

/* Selo um pouco menor para não competir com o título. */
.brand-seal {
...
/* ---------- AJUSTES DE DIAGRAMAÇÃO v1.2 ---------- */

/* Página da Salmão: imagem compacta para não estourar a primeira coluna. */
.page:nth-of-type(8) .section-image {
  width: 100% !important;
...
.page:nth-of-type(8) .image-caption {
  margin-top: -1mm !important;
  margin-bottom: 2.5mm !important;
}

/* Página do gerador: ignora o fluxo de colunas nativo e usa grade fixa. */
.generator-page {
  position: absolute;
  top: 14mm;
  right: 15mm;
...
.generator-page .generator table {
...
.generator-page .generator th,
.generator-page .generator td {
  padding: .65mm 1mm !important;
}

.generator-page .generator h3 {
...
/* Retrato de Mara: URL alternativa e tamanho editorial estável. */
.page:nth-of-type(9) .portrait-image {
  display: block !important;
...
<img class="full-bleed" src="https://raw.githubusercontent.com/atavernadododorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/locations/Salm%C3%A3o%20em%20Piracema.webp" alt="A Salmão em Piracema ao entardecer">

<div class="cover-copy">
  <img class="brand-seal" src="https://raw.githubusercontent.com/atavernadododorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/covers/Cronicas%20de%20Valvurth%20Selo.webp" alt="Selo de Crônicas de Valvurth">
  <div class="cover-series">CRÔNICAS DE VALVURTH</div>
  <div class="cover-line">VÉSPERA</div>
  <div class="cover-setting">CANDELÁRIA VELHA</div>
  <div class="cover-title">PRIMEIRAS CHAMAS</div>
  <div class="cover-ornament">◆</div>
  <div class="cover-subtitle">
    GUIA INTRODUTÓRIO GRATUITO<br>
    <span class="cover-subtitle-small">DE CANDELÁRIA VELHA</span>
  </div>
  <div class="cover-author">DAN UMBALI</div>
</div>
...
<span class="dropcap">P</span>rimeiras Chamas é um guia introdutório gratuito para Candelária Velha, um cenário de fantasia medieval urbana pertencente ao universo Crônicas de Valvurth.
...
<span class="dropcap">H</span>á cidades que crescem ao redor de castelos.
...
<span class="dropcap">À</span> primeira vista, Candelária Velha parece apenas mais uma antiga cidade erguida às margens de um grande rio. Muralhas de pedra cercam seus bairros, pontes unem margens movimentadas e embarcações cruzam diariamente o Rio Cristal Velho levando pessoas, mercadorias e notícias para toda a região de Véspera.
...
<span class="dropcap">E</span>m Candelária Velha, cada amanhecer começa com o som das embarcações deslizando pelo Rio Cristal Velho. Mercadores organizam suas barracas antes mesmo do nascer do sol, padeiros acendem os primeiros fornos e artesãos abrem as portas de oficinas que pertencem às mesmas famílias há gerações.
...
<img class="map" src="https://raw.githubusercontent.com/atavernadododorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/maps/Mapa%20Cristal%20V%C3%A9lho.webp" alt="Mapa de Candelária Velha">
...
<span class="dropcap">C</span>ada região de Candelária possui um ritmo próprio. Escolha um distrito, apresente sua primeira impressão e deixe que uma oportunidade de aventura conduza os personagens para dentro da cidade.
...
<img class="section-image" src="https://raw.githubusercontent.com/atavernadododorpg-design/Cronicas-de-Valvurth/main/assets/candelaria-velha/locations/Salm%C3%A3o%20em%20Piracema.webp" alt="A Salmão em Piracema">
<div class="image-caption">A estalagem fluvial mais famosa de Candelária Velha.</div>

<span class="dropcap">M</span>uitas cidades possuem um lugar onde histórias começam.
...
<img class="portrait-image" src="https://github.com/atavernadododorpg-design/Cronicas-de-Valvurth/raw/refs/heads/main/assets/candelaria-velha/npcs/Mara.webp" alt="Mara Sete Nós">
<div class="image-caption">Mara “Sete Nós”, proprietária da Salmão em Piracema.</div>

<span class="dropcap">P</span>oucas pessoas conhecem Candelária Velha tão bem quanto Mara “Sete Nós”.
...
<span class="dropcap">A</span> maneira mais simples de iniciar uma campanha é reunir os personagens como passageiros da Salmão em Piracema.
...
<span class="dropcap">C</span>andelária Velha não é definida apenas por seus lugares ou habitantes.
...
<span class="dropcap">R</span>uínas antigas, passagens subterrâneas e acontecimentos pouco comentados fazem parte da memória de Candelária Velha. Nem todos desejam que essas histórias voltem à superfície.
...
<span class="dropcap">C</span>andelária Velha foi feita para crescer junto com sua campanha.
...
<span class="dropcap">S</span>e você chegou até aqui, já conhece o suficiente para começar uma campanha em Candelária Velha.
